      ...
      <div class="manage_tip">
        ...
        >
          ...
          <el-form-item label="邮箱" prop="email">
            <el-input type="text" v-model="registerUser.email" placeholder="请输入e-mail"></el-input>
          </el-form-item>
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          params.append("password", this.registerUser.password);
          params.append("identity", this.registerUser.identity);
          this.$axios.post("/management_api/register.php", params).then(res => {
            // console.log(res);
